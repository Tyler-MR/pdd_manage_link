...
class Server(SimpleHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            if path == "/api/orders":
                ...
                self.json_resp(result)
            elif path in ("/api/operation", "/api/operation/complete", "/api/delist", "/api/delist/complete", "/api/promotion-adjust", "/api/promotion-adjust/complete"):
    ...
    def do_GET(self):
        ...
        elif path in ("/api/operation/pending", "/api/operation/history", "/api/delist/pending", "/api/delist/history", "/api/promotion-adjust/pending", "/api/promotion-adjust/history"):
